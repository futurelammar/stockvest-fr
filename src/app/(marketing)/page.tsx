...
function Testimonials() {
  ...
  const defaults = [
    { name: 'James O.',  role: 'Retail Investor',    rating: 5, content: 'Pitlane Markets gave me consistent 18% returns in 60 days. The dashboard is clean and deposits are fast.' },
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mx-auto mb-8 max-w-xl" style={{ color: MUTED }}>
              Join thousands of investors already growing their wealth on Pitlane Markets
